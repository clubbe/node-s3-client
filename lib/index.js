...
function syncDir(self, params, directionIsToS3) {
  ...
  var allLocalFiles = [];
  var allS3Objects = Object.assign([], params.allS3Objects);
  var localFileCursor = 0;
  var s3ObjectCursor = 0;
  var objectsToDelete = [];

  delete params.allS3Objects;
    ...
    function uploadLocalFile() {
      ...
      function startUpload() {
        ...
        uploader.on('end', function (data) {
          ee.activeTransfers--;
          ee.emit('fileUploadEnd', data, localFileStat, fullPath, fullKey);
          ee.emit('progress');
          checkDoMoreWork();
        });
      }
  ...
  function findAllS3Objects() {
    ...
    if (allS3Objects.length > 0) {
      allS3Objects.sort(function (a, b) {
        if (a.key < b.key) {
          return -1;
        } else if (a.key > b.key) {
          return 1;
      ...
      ee.objectsFound = allS3Objects.length;
